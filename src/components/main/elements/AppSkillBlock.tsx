...

        {
          skill.folder ?
            <>
              ...
              <div className="absolute rounded-[4px] top-0 left-0 right-0 bottom-0 border border-solid border-[#CCCCCC]"></div>
            </>
            :
            <>
              <div
                ...
                className={`absolute z-[-1] group-hover/item:backdrop-blur-xs transition-all duration-500 rounded-[4px] top-0 left-0 right-0 bottom-0 border border-solid`}
                ></div>

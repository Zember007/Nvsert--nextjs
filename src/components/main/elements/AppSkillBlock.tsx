...
const AppSkillBlock = (skill: any) => {
  ...
  return (
    <div className="card-wrap"
      ...
      ref={cardRef}>
      <div className={`card relative group/item l:mr-0 mr-[20px] rounded-[4px] flex  flex-col gap-[20px] justify-between ${skill.folder ? '!items-center !justify-center' : 'p-[20px]'} text-[${skill.bg !== 'secondary' ? '#000' : '#FFF'}] bg-[${skill.bg === 'secondary' ? '#00000099' : '#FFF'}] h-[250px] min-w-[300px] w-full`}
      ...
      >
        {
          skill.folder ?
            ...
            <>
              ...
              <button className="rebound-box  w-full flex items-center text-left">

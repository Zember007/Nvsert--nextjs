        ...
        <div className={`relative flex flex-col rounded-[4px] bg-[#FFFFFF] z-[0]`}>
            ...
            <div
                ...
                <div className="w-[70px] h-[70px] flex items-center justify-center">
                    <p className={`${active && 'text-[50px] text-[#FFF]'} text-[22px] rubik group-hover:text-[50px] group-active:duration-[0] ease-in-out transition-all duration-300 group-active:text-[#FFF]`}>{number}</p>
                </div>
                <div className="group-active:scale-[0.99] grow will-change-transform ease transition-all duration-100  flex items-center gap-[40px]">
                    <p className={`${active ? '[text-shadow:0_0_0.7px_white] text-[#FFF]' : 'group-hover:[text-shadow:0_0_0.7px_black]'} grow text-[18px] ease-in-out transition-all duration-300 group-active:duration-[0] font-[400] group-active:text-[#FFF]  group-active:[text-shadow:0_0_0.7px_white]`}>{title}</p>
                    <button>
                        <svg

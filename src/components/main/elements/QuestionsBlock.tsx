            ...
            <div className={`max-h-[0px] transition-all easy-in duration-200 overflow-hidden ${active && '!max-h-[1000px]'}`}>
                <div className="pl-[110px] pr-[34px] py-[30px] flex flex-col gap-[30px]">
                    ...
                    <div
                        ...
                        <button
                            ref={setButtonRef} className='btnIconAn group-hover/box:border-[transparent] border-[#34446D] border-solid border group-hover/box:bg-[#34446D] group-hover/box:text-[#FFF] an-border tariff text-[20px] transition-all duration-300 font-bold tracking-normal  gap-[6px]  text-[#FFF] rounded-[4px] group   leading-[1]'>

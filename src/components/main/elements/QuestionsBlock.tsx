            ...
            <div className={`max-h-[0px] transition-all easy-in duration-200 overflow-hidden ${active && '!max-h-[1000px]'}`}>
                <div className="pl-[110px] pr-[34px] py-[30px] flex flex-col gap-[30px]">
                    ...
                    <div
                        ...
                        <button
                            ref={setButtonRef} className='btnIconAn an-border tariff text-[20px] transition-all duration-300 font-bold tracking-normal  gap-[6px]  text-[#FFF] rounded-[4px] group bg-[#34446D]  leading-[1]'>

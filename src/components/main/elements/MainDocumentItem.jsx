                                    ...
                                    <div className=" flex flex-col justify-between  items-start">
                                        ...
                                        <motion.div
                                            ...
                                            <button
                                                ...
                                                ref={setButtonRef}
                                                className='btnIconAn doc-btn tariff justify-center text-[20px] group hover:bg-[#34446D] hover:text-[#FFF] font-bold tracking-normal m:flex items-center gap-[10px] hidden px-[16px] py-[9px] text-[#34446D] rounded-[4px] border-[#34446D] border border-solid leading-[1]'>

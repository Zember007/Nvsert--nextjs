                            ...
                            <div className="w-[40%] items-start flex gap-[20px] flex-col   text-[#000]">
                                ...
                                <motion.div
                                    ...
                                    <button
                                        ...
                                        ref={setButtonRef} className='btnIconAn doc-btn justify-center border-[#34446D] border border-solid tariff text-[20px] transition-all duration-300 font-bold tracking-normal m:flex items-center gap-[6px] px-[16px] py-[9px] text-[#34446D] hover:text-[#FFF] rounded-[4px]  group hover:bg-[#34446D]  leading-[1]'>

...
const ActionButton = memo(({ onClick, icon, text, className, setRef }: ActionButtonProps) => (
    <button ref={setRef} onClick={onClick} className={`justify-center w-full m:flex items-center px-[16px] py-[9px] relative overflow-hidden ${className}`}>
        ...
        <>
            ...
            <div
                ...
                <div
                    ...
                    className={`rounded-[6px] -mx-[1px] w-[calc(100%+2px)]   text-left group/window box-scale active:shadow-[2px_2px_4px_0px_#000000CC_inset,-2px_-2px_4px_0px_#000000CC_inset] transition-scale ${!active ? '' : ' bg-[#5B6788]  shadow-[2px_2px_4px_0px_#000000CC_inset,-2px_-2px_4px_0px_#000000CC_inset]'} active:bg-[#5B6788]  px-[23px]  relative w-full  z-[0]`}>
                    ...
                    <Image
                        className={`border-[0.2px] solid border-[#A4A4A4] rounded-[5px] ${active && ' translate-y-[100%]'} transition-all duration-100   z-[2] absolute top-1/2 -translate-y-1/2 left-[23px]`}
                        ref={smallPhotoRef}
                                    ...
                                    <div className=" flex flex-col justify-between  items-start">
                                        ...
                                        <motion.div
                                            ...
                                            <ActionButton
                                                ...
                                                icon={
                                                    <svg className=' group-hover:*:fill-[#FFF] *:transition-all' width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">

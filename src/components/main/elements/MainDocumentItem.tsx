            ...
            <div key={contIndex} className='document__list-item'>
                ...
                {cont.list.length > 3 && (
                    ...
                    >
                        ...
                        <svg className={`${!listHidden ? 'rounded-[180deg]' : ''}`} xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" fill="#34446D" version="1.1" id="Layer_1" width="16" height="16" viewBox="0 0 100 100" enable-background="new 0 0 100 100" xml:space="preserve">
                            <g>

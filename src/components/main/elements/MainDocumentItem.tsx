                            ...
                            >
                                <div className="s:py-[23px] py-[15px]  flex flex-col l:flex-row gap-[10px] ">
                                        ...
                                        <div ref={containerPhotoRef} className="grow flex justify-center">
                                            <div className=" flex flex-col justify-between  items-start">
                                                ...
                                                <div className="tariff-wrap w-[250px]" ref={setWrapperRef}>
                                                    <button ref={setButtonRef} className='tariff text-[20px] group hover:bg-[#34446D] hover:text-[#FFF] font-bold tracking-normal m:flex items-center gap-[10px] hidden px-[16px] py-[9px] text-[#34446D] rounded-[4px] border-[#34446D] border border-solid leading-[1]'>
                                    ...
                                    <div className="w-[40%] items-start flex gap-[20px] flex-col   text-[#000]">
                                        ...
                                        <div className="tariff-wrap w-[250px]" ref={setWrapperRef}>
                                            <button ref={setButtonRef} className=' border-[#34446D] border border-solid tariff text-[20px] transition-all duration-300 font-bold tracking-normal m:flex items-center gap-[6px] px-[16px] py-[9px] text-[#34446D] hover:text-[#FFF] rounded-[4px]  group hover:bg-[#34446D]  leading-[1]'>

...
const AppIntroForm = ({ close, BounceWrapper }: { close?: () => void; BounceWrapper?: () => void }) => {
    ...
    return (
        <motion.div
            ...
            <div className={`${successMessageVisible && 'opacity-0'} no-drag flex flex-col gap-[40px]`}>
            ...
            {successMessageVisible && <FlightSuccess small={true} text="Спасибо" close={() => { setSuccessMessageVisible(false) }} />}

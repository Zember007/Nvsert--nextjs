                    ...
                    <div className={`${successMessageVisible && 'opacity-0'} flex flex-col gap-[20px]`}>
                        ...
                        <div ref={setWrapperRef} className="tariff-wrap relative mt-[24px]">
                            <button
                                type="submit"
                                ref={setButtonRef}
                                className="overflow-hidden p-[9px] px-[20px] relative flex items-center justify-center no-drag btnIconAn group  tariff an-border bg-[#34446D] text-[14px] s:text-[20px] text-[#FFFFFF] font-bold   rounded-[4px]"      
                            >

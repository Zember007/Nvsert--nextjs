    ...
    return (
        <motion.div
            ...
            <div className="h-[16px] s:h-[23px]">
                <span className={` text-[#000] text-[24px] s:text-[32px] font-light ${bg ? 'text-center' : 'text-left'} tracking-[-0.03em] s:px-[8px]  ${successMessageVisible && 'opacity-0'} `}>Оформить заявку</span>
            </div>

      ...
      <div className="flex xl:gap-[120px] gap-[30px] xl:items-stretch items-center xl:flex-row flex-col-reverse">
        ...
        <div className="flex flex-col xl:justify-between xl:items-start gap-[20px] items-center relative">
          ...
          <div className="flex gap-[10px] xl:flex-row flex-col">
            <AppMenuItem
              className="after:!content-none xl:after:!content-[''] border border-solid border-[#93969D] xl:!h-[35px] !h-[50px] !justify-center"
            ...
            {email &&
              ...
              >
                <AppMenuItem
                  ...
                  className="after:!content-none xl:after:!content-[''] xl:!px-[31.5px] border border-solid border-[#93969D] xl:!h-[35px] xl:w-auto !h-[50px] w-[200px] group"
                  item={{
                    href: '#', label:
                      <>
                        <span className="transition-all duration-200 ease block xl:group-hover:translate-x-[16px]">{email.value}</span>
                        <svg className="xl:absolute top-1/2 transition-all duration-200 ease xl:-translate-y-1/2 xl:-translate-x-full left-[-1px] group-hover:translate-x-0 group-hover:left-[15px]" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                item={{
                  href: '#', label:
                    <>
                      ...
                      <svg className="xl:absolute top-1/2 transition-all duration-200 ease  left-[-1px] -translate-x-full xl:-translate-y-1/2 translate-x-0 group-hover:translate-x-0 group-hover:left-[16px]" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                item={{
                  href: '#', label:
                    <>
                      ...
                      <svg className="xl:absolute top-1/2 transition-all duration-200 ease left-[-1px] -translate-x-full  xl:-translate-y-1/2 translate-x-0 group-hover:translate-x-0 group-hover:left-[15px]" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">

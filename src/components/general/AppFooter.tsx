                  ...
                  item={{
                    href: '#', label:
                      <div>
                        ...
                        <span className="transition-all duration-200 ease block group-hover:translate-x-[14px]">{email.value}</span>
                      </div>
                  }} isActive={false} />
                ...
                item={{
                  href: '#', label:
                    <div>
                      ...
                      <span className="transition-all duration-200 ease block group-hover:text-[#2AABEE] group-hover:translate-x-[14px]">Telegram</span>
                    </div>
                }} isActive={false} />
            </PromtModal>
            <PromtModal
                ...
                item={{
                  href: '#', label:
                    <div>
                      ...
                      <span className="transition-all duration-200 ease block group-hover:text-[#60D669] group-hover:translate-x-[14px]">WhatsApp</span>
                    </div>
                }} isActive={false} />
            </PromtModal>
            <PromtModal

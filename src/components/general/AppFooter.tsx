                  ...
                  item={{
                    href: '#', label:
                      <>
                        ...
                        <svg className="xl:absolute top-1/2 transition-all duration-200 ease xl:-translate-y-1/2 -translate-x-full left-[-1px] group-hover:translate-x-0 group-hover:left-[15px]" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">

            ...
            >
              <AppMenuItem
                ...
                item={{
                  href: '#', label:
                    <div>
                      <svg className="absolute top-1/2 transition-all duration-200 ease -translate-y-1/2 left-[-1px] -translate-x-full group-hover:translate-x-0 group-hover:left-[15px]" width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <span className="transition-all duration-200 ease block group-hover:text-[#2AABEE] group-hover:translate-x-[15px]">Telegram</span>
                    </div>
                }} isActive={false} />
            </PromtModal>
            <PromtModal

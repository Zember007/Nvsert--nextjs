...
const AppFooter = () => {
  ...
  return (
    <footer ref={ref} className="footer grid xl:grid-cols-2 xl:grid-rows-2 gap-[2px]">
      ...
      <div className="footer__white  gap-[10px] xl:flex-row flex-col">
        ...
        {email &&
          ...
          >
            <AppMenuItem
              ...
              className="sendBtn max-xl:!border-[#93969D] gap-[8px]  xl:!h-[35px] w-[280px] xl:mx-0 mx-auto !h-[50px] xl:w-auto"
              item={{
                href: '#', label:
                  <>
        ...
        >
          <AppMenuItem
            className="sendBtn max-xl:!border-[#93969D]  xl:!h-[35px] xl:w-auto w-[280px] xl:mx-0 mx-auto  !h-[50px]  group"
            item={{
              href: '#', label:
                <>
        ...
        >
          <AppMenuItem
            ...
            item={{
              href: '#', label:
                <>
                  <span className="sendTextFooter group-hover:text-[#60D669]">WhatsApp</span>
        ...
        <PromtModal
          classNameBox="*:fill xl:!relative !absolute xl:bottom-0 xl:right-0 bottom-[-75px] right-[40px]"
          className='!py-[20px]'
          content={
        ...
        >
          <AppMenuItem
            item={{
              href: '#', label: <>
                <svg
                className="xl:*:fill-black *:fill-white"

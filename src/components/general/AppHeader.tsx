              ...
              item={{
                href: '#', label:
                  <div>
                    ...
                    <span className={`transition-transform block ${darkHeader ? 'group-hover:!text-[#34446D]' : 'group-hover:!text-[#34C759]'} group-hover:translate-x-[16px]`}>Заказать звонок</span>
                  </div>
              }} isActive={false} />
            <AppMenuItem
              item={{

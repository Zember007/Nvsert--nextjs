...
const AppHeader = () => {
  ...
  return (
    <>
              ...
              item={{
                href: '#', label:
                  <div>
                    ...
                    <span className={`transition-transform block ${darkHeader ? '' : 'group-hover:!text-[#34C759]'} group-hover:translate-x-[20px]`}>Заказать звонок</span>
                  </div>
              }} isActive={false} />
            <AppMenuItem
              item={{
      ...
      <div className={`services-menu py-[20px] js-services-menu relative ${servicesMenuActive && 'active'}`}>
        <div className="services-menu__wrapper select-none">

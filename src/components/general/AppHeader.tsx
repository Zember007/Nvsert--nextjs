...
const AppHeader = () => {
  ...
  return (
    <>
      ...
      <div className={`border border-solid border-[#FFF] w-[385px] header__bg !backdrop-blur-0 gap-[8px] l:!flex !hidden mix-blend-difference fixed h-[48px] top-[2px] right-[193.5px] z-[51] `}>
        <AppMenuItem
          onClick={() => {
      ...
      <Link
        ...
        className={`border border-solid border-[#FFF] l:!hidden !backdrop-blur-0 ${burgerMenuActive ? 'active' : 'mix-blend-difference'} header__bg fixed h-[48px] top-[2px] right-[60px] z-[51] `}
      >

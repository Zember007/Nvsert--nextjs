          ...
          <div className="flex gap-[8px]">
            <AppMenuItem
              ...
              item={{
                href: '#', label:
                  <div>
                    <svg className="absolute top-1/2 transition-all  ease -translate-y-1/2 left-[-1px] -translate-x-full group-hover:translate-x-0 group-hover:left-[10px]" width="30" height="31" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className={`transition-transform block ${darkHeader ? 'group-hover:!text-[#34446D]' : 'group-hover:!text-[#34C759]'} group-hover:translate-x-[12px]`}>Заказать звонок</span>
                  </div>
              }} isActive={false} />
            <AppMenuItem
              item={{

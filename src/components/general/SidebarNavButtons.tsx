...
const SidebarNavButtons = () => {
    ...
    const items = [
        {
            ...
            icon: (
                <svg className='text-[#93969D]' width="20" height="26" viewBox="0 0 20 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" clipRule="evenodd" d="M11.8519 1.21429V7.28572C11.8519 7.56988 11.9689 7.8424 12.1773 8.04333C12.3857 8.24426 12.6683 8.35714 12.963 8.35714H19.2593L11.8519 1.21429Z" fill={!isAbout ? '#93969D' : "#FFF"} />
    ...
    return (
        <div className={`m:flex xxs:grid xxs:grid-cols-2 xxs:gap-[20px] m:gap-[10px] flex flex-col h-full`}>

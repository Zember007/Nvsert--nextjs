                    ...
                    <div
                        ...
                        >
                            <svg className={`transition-all ${itemActive && 'rotate-[45deg] *:stroke-[#34446D]'} `} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M14 8L2 8" stroke="#93969D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M8 2V14.0001" stroke="#93969D" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </button>
                    </div>

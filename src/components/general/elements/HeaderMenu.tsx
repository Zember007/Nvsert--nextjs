...
const HeaderMenu = ({ active }: { active: boolean }) => {
    ...
    const handleGoBack = (i: number) => {
        ...
        if (navigationStack.length === i + 1) return

        setNavigationStack(prev => prev.slice(0, -(navigationStack.length - i - 1)));
    };
        ...
        <div className={`header__menu-mob ${active && 'active'}`}>
                        ...
                        {canGoBack && navigationStack.map((item, i) => (
                            <>
                                <span
                                    ...
                                    className={`cursor-pointer text-[18px] text-[#FFF] ${i !== navigationStack.length - 1 ? 'flex items-center gap-[10px] after:text-[#adadad] after:content-["/"]' : ''}`}>
                                    {i === 0 ?
            ...
            <div className="flex flex-col gap-[10px]">
                ...
                <div className="button-menu">
                    ...
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M11 0C4.9251 0 0 4.9251 0 11C0 17.0749 4.9251 22 11 22C17.0749 22 22 17.0749 22 11C22 4.9251 17.0749 0 11 0ZM2.57882 7.51183C2.12075 8.61772 1.88498 9.803 1.88498 11C1.88498 13.4175 2.84531 15.7359 4.55471 17.4453C6.26411 19.1547 8.58255 20.115 11 20.115C13.4175 20.115 15.7359 19.1547 17.4453 17.4453C19.1547 15.7359 20.115 13.4175 20.115 11C20.115 9.803 19.8792 8.61772 19.4212 7.51183C18.9631 6.40595 18.2917 5.40112 17.4453 4.55471C16.5989 3.7083 15.5941 3.03689 14.4882 2.57882C13.3823 2.12075 12.197 1.88498 11 1.88498C9.803 1.88498 8.61772 2.12075 7.51183 2.57882C6.40595 3.03689 5.40112 3.7083 4.55471 4.55471C3.7083 5.40112 3.03689 6.40595 2.57882 7.51183Z" fill="white" />
                    </svg>
                </div>
                <div className="button-menu">
                    <span className='text-[#60D66]'>WhatsApp</span>
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
